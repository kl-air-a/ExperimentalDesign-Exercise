...
def _save(df, sheet_name):
    ...
    try:
        ...
        return f"❌ File not found: {path}. Upload it to the current directory or use a full path."
    except Exception as e:
        return f"❌ Error while saving: {type(e).__name__}: {e}"
...
def table_intuitive():
    ...
    init_df = pd.DataFrame({
        "Current Slope": [None, None, None, None, None, None, None, None, None],
        "Current Constant": [None, None, None, None, None, None, None, None, None],
